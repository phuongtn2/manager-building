            ...
            <div class="ibox-content">
                <form:form class="form-horizontal" modelAttribute="newsDto" method="post">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Title</label>
                        <div class="col-lg-8"><input name="title" type="text" placeholder="Title" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button name="add" class="btn btn-sm btn-white" type="submit">Tạo Mới</button>
                        </div>
                    </div>
                </form:form>
            </div>
